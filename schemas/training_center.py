...
class TrainingCenterIn(BaseSchema):
    name: Annotated[str, Field(description='Nome do centro de treinamento',
                               example='CT Monster', max_length=20)]
    address: Annotated[str, Field(description='Endereço do centro de treinamento',
                                  example='Rua Belém, 230', max_length=60)]
    owner: Annotated[str, Field(description='Proprietário do centro de treinamento',
                                example='Guilherme', max_length=30)]
